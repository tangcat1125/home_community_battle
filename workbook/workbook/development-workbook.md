...
7. `player_window/player-window.html` - player-facing gameplay window with auto-deal and reel rotation.
...
The player-facing window is now a separate subsystem and should be backed up independently.
Its main behaviors are auto-deal hand flow, HUD layering, and reel-like table motion.
The latest safety snapshot is `2026-06-12_110522`.

...
# 2026-06-17_before-index-shell-ending-credits-github

- 備份資料夾：`D:\Codex\home_community_battle\workbook\backups\2026-06-17_before-index-shell-ending-credits-github`
- 備份目的：修正結局評估流程與 index 單頁啟動前，保存可回復版本。
- 備份檔案：
  - `index.html`
  - `player-window.html`
  - `build-command-workbook.mjs`
...
- 本輪修改：
  - 成績評估系統按關閉後，改為進入感謝頁。
  - 感謝頁保留感謝贊助開發、THE END OR REPLAY AGAIN 與 REPLAY AGAIN。
  - `index.html` 改為單頁入口，以 iframe 內嵌玩家視窗，網址列維持 index。
  - Excel 工作簿新增第 055 筆開發指令紀錄。

# 2026-06-17_before-hand-manage-overlay-upload

- 備份資料夾：`D:\Codex\home_community_battle\workbook\backups\2026-06-17_before-hand-manage-overlay-upload`
- 備份目的：新增手牌整理放大區與 GitHub 上傳前，保存可回復版本。
- 備份檔案：
  - `player-window.html`
  - `build-command-workbook.mjs`
  - `backup-index.md`
  - `README.md`
- 本輪修改：
  - 新增中央放大的 `hand-manage-overlay` 手牌整理區。
  - 點擊手牌夾或「整理換牌」會開啟整理區。

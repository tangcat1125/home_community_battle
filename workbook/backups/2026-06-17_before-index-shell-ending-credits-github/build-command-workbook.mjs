...
overview.getRange("A2").values = [["本工作簿記錄從原型、玩家視窗、圖資、HUD、AI、結局分析到本輪 AI 性格與烏雲覆蓋修正的主要開發指令。"]];
...
writeTable(
  ...
  [
    ...
    ["本輪新增", "AI 性格與烏雲覆蓋", "player_window/player-window.html", "一人模式 P2/P3/P4 AI 會依頑皮、經營、慢熱性格自動行動；烏雲以 storm-layer 覆蓋各玩家桌牌區。"],
  ],
  [160, 130, 260, 520],
);

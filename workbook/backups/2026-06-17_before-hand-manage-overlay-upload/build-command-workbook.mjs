...
overview.getRange("A2").values = [["本工作簿記錄從原型、玩家視窗、圖資、HUD、AI、結局分析到本輪 index 單頁啟動與感謝頁流程的主要開發指令。"]];
...
writeTable(
  ...
  [
    ...
    ["本輪新增", "index 單頁啟動與感謝頁流程", "index.html、player_window/player-window.html", "index 以 iframe 內嵌玩家視窗，網址維持 index；結局評估按關閉後進入電影字幕式感謝頁。"],
  ],
  [160, 130, 260, 520],
);
